...
sub _updateGUIPreferences {
    ...
    if (!defined $$cfg{'defaults'}{'hide info tab'}) {
        $$cfg{'defaults'}{'hide info tab'} = 0;
    }
    ...
    _($self, 'cbCfgHideInfoTab')->set_active($$cfg{'defaults'}{'hide info tab'});
...
sub _saveConfiguration {
    ...
    $$self{_CFG}{'defaults'}{'hide info tab'} = _($self, 'cbCfgHideInfoTab')->get_active();
