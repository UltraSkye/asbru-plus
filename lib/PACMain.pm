...
our $APPICON = "$RES_DIR/asbru-logo-64.png";
...
# Sidebar tab refresh + info-pane refresh live in PAC::UI::Refresh.
# PACMain keeps proxies so external callers (PACConfig / PACEdit /
# PACTerminal call _updateGUIPreferences) keep working.
require PAC::UI::Refresh;
sub _updateGUIWithUUID        { goto &PAC::UI::Refresh::with_uuid; }
sub _clearLeftMenuTabLabels   { goto &PAC::UI::Refresh::clear_tab_labels; }
sub _updateGUIPreferences     { goto &PAC::UI::Refresh::preferences; }
sub _updateGUIFavourites      { goto &PAC::UI::Refresh::favourites; }
...
sub __dupNodes {
    ...
    my $new_txt_uuid = create_uuid_as_string(UUID_V4);
...
# Bulk-edit dialog lives in PAC::Dialog::BulkEdit.
require PAC::Dialog::BulkEdit;
sub _bulkEdit {
    shift;   # $self — unused, dropped during P4/7 extraction
    return PAC::Dialog::BulkEdit::show(@_);
}
